...
element for Ustay, not decoration — these define the *character* of the movement.

---

## 1. Jomor Design — https://www.jomor.design/ (Jonathan Morin, Webflow)

The key motion reference — user: *"I really like the scroll animation for this website."*
...
- **Tonal transitions on scroll** — the background shifts light → dark → full-bleed photo as
  you move down. ⭐ *This literally resolves our dark-vs-light fork:* the page doesn't pick one,
...
**Character:** slow, eased, weighted, immersive, quiet — the motion encodes the *same* unhurried
...
## 2. 21st.dev components (React/shadcn — reimplement the *effect* in Svelte)
