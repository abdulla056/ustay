...
Your ~8 favorites, each with **one sentence naming the specific move you like** —
...
- **Tags:** moody / cinematic / immersive · airy light sans (not serif) · glassmorphism ·
...
- **Tags:** editorial / literate · high-contrast serif · green natural accent · shaped photo cutout ·
...
- **What I like (the specific move):** Fully **dark** editorial luxury — a near-black canvas lets
  ...
  / THE EXPERIENCES / THE DESTINATION") acting as editorial signposts. Slider/carousel sections with
  minimal circular prev/next controls; small portrait image insets break the grid. Understated,
  quiet, refined — moody without feeling heavy.
...
- **What I like (the specific move):** The most **editorial/magazine** of the set. A **calligraphic
  ...
  hero and repeats as a monogram — a real signature. A **numbered section system** (01 Essence,
  03 Concierge, 04 Vignettes/Legacy) with named eyebrows — structure that encodes sequence.
  Alternates full-bleed warm architectural imagery with generous white editorial space; headlines
  mix italic-swash + roman caps for rhythm; experiences shown as a card row with carousel arrows.
- **Tags:** editorial/magazine · calligraphic high-contrast serif + monogram · numbered sections ·
...
## Through-line (fill in once ~8 are collected)

- **Adjectives it should feel (3–5):** _emerging:_ immersive, serene, nature-forward, escapist, premium
- **Anti-references (not this):** _emerging:_ not a busy OTA listing grid; not flat/corporate
- **Recurring moves I keep saving (across #1–4):**
  - Full-bleed **cinematic photography** (nature + architecture) that fills the viewport and lands first
  - **Oversized display type set over / bleeding across the image**
  - Minimal top nav + a single pill **Book / Reserve** CTA
  - **Editorial storytelling coexisting with the booking product** on the same screen
  - **Numbered, named editorial sections** (Asteren 01/03/04; Lunara brackets) — structure as signature
  - "Big picture to land, then animation carries you down"
- **Fork — mostly resolved:**
  - Display type: **elegant / high-contrast SERIF now leads 3 of 4** (Lunara, Asteren, Villa Embrace);
    only Woodvelly is sans. → direction is **serif / editorial luxury.**
  - Still open: overall tone — **moody-dark** (Woodvelly, Villa Embrace) ⟷ **light editorial** (Lunara,
    Asteren). Likely resolution: **cinematic (darker) hero → refined lighter editorial body**, since
    Lunara & Asteren both do exactly that.
- **Motion reference captured:** Jomor Design (jomor.design) — layered parallax, big-type-meets-
  imagery, tonal light↔dark shifts on scroll, smooth weighted momentum. See `references/MOTION.md`.
  Notably its on-scroll tonal shift **resolves the dark-vs-light fork** (move between them, don't pick).
